        ...
        <div className={styles.footerColumn}>
          ...
          <div className={styles.paymentMethods}>
            ...
            <div className={styles.paymentIcons}>
              <div className={`${styles.paymentIcon} ${styles.googlePay}`}>G Pay</div>
              <div className={`${styles.paymentIcon} ${styles.mastercard}`}>MC</div>
              <div className={`${styles.paymentIcon} ${styles.paypal}`}>PayPal</div>
              <div className={`${styles.paymentIcon} ${styles.amex}`}>AMEX</div>
              <div className={`${styles.paymentIcon} ${styles.applePay}`}>🍎 Pay</div>
              <div className={`${styles.paymentIcon} ${styles.shopPay}`}>S Pay</div>
            </div>
          </div>
        </div>
      </div>
