...
import styles from '../styles/index.module.css'; // Ensure this matches your CSS file
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Explore the latest products from mettà muse. Discover unique items and offers." />
      ...
      <main className={styles.main}>
        ...
        <div className={styles.topBar}>
          ...
          <div className={styles.hideFilterFrame} onClick={() => alert('Filter toggled')}>
            <span className={styles.hideFilterArrow}></span> {/* Placeholder for arrow SVG */}
          ...
          <div className={styles.recommendedFrame} onClick={toggleDropdown}>
            ...
            <span className={styles.recommendedArrow}></span> {/* Placeholder for arrow SVG */}
          ...
          <div className={styles.sortFrame} style={{ visibility: 'hidden' }}></div>
